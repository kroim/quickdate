...
class Connection implements ConnectionInterface
{
    ...
    protected function run($query, $bindings, Closure $callback)
    {
        ...
        global $console_log;
        // if( $query !== "select * from information_schema.tables where table_schema = ? and table_name = ?"){
        //     $console_log['database'][] = array("Execution time" => $time, "Query" => $query, "Bindings" => $bindings, "Data" => $result);
        //     $console_log['database_time'] += $time;
        // }
    ...
    {
        return microtime(true) - $start;//round((microtime(true) - $start) * 1000, 2);
    }
